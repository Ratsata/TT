...
public class jfIngresar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ingrese datos curso");

        jLabel2.setText("Codigo Curso:");

        jLabel3.setText("Nombre Curso:");

        jTextField1.setText("M1A");

        jTextField2.setText("Primero Medio A");

        jButton2.setText("Finalizar");

        jRadioButton1.setText("Enseñansa Basica");

        jRadioButton2.setText("Enseñansa Media");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Primero" }));

        jRadioButton3.setText("Paralelo A");

        jRadioButton4.setText("Paralelo B");

        jLabel4.setText("Codigo y nombre generados");
