...
public class jfNotas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Si desea el informe de notas de un alumno ingrese el rut del alumno en cuestion:");

        jTextField1.setText("186183177");

        jButton1.setText("Buscar");

        jLabel2.setText("Nombre alumno:");

        jLabel3.setText("Curso alumno:");

        jButton2.setText("Generar informe");

        jLabel4.setText("Si desea el informe de notas de un curso eliga el curso en cuestion:");
